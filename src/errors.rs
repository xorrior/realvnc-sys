...
extern "C" {
    #[doc = " Gets the error produced by the last API call."]
    #[doc = ""]
    #[doc = " @return A string ID indicating the type of error.  See individual function"]
    #[doc = "   documentation for details of which error types each function can produce."]
    #[doc = " @retval 0 No error occurred"]
    #[doc = " @retval 'Unknown' An error occurred but the exact cause is not known"]
    pub fn vnc_getLastError() -> *const ::std::os::raw::c_char;
}
