...
VNC_SDK_API _Ret_valid_ const vnc_PixelFormat* vnc_PixelFormat_rgb888(void);

/** 32 bits per pixel stored as XXXXXXXXBBBBBBBBGGGGGGGGRRRRRRRR in most
 *  significant to least significant bit order */
VNC_SDK_API _Ret_valid_ const vnc_PixelFormat* vnc_PixelFormat_bgr888(void);

/** 16 bits per pixel stored as RRRRRGGGGGGBBBBB in most significant to least
 *  significant bit order */
VNC_SDK_API _Ret_valid_ const vnc_PixelFormat* vnc_PixelFormat_rgb565(void);

/** 16 bits per pixel stored as XRRRRRGGGGGBBBBB in most significant to least
 *  significant bit order */
VNC_SDK_API _Ret_valid_ const vnc_PixelFormat* vnc_PixelFormat_rgb555(void);
